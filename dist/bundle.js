...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const watsFilter = (body, title, key = 'wats-segment') => {
    try {
        const filterBlockElement = document.createElement('div');
        filterBlockElement.classList.add('filter-block');
        const filterTitleElement = document.createElement('div');
...
const watsFilter_1 = __importDefault(__webpack_require__(/*! ../helps/watsFilter */ "./js/lamps/helps/watsFilter.ts"));
    ...
    try {
        ...
        switch (typeLamps) {
            ...
            case 'light':
                ...
                (0, watsFilter_1.default)(blockForFilters, 'Мощность');
        ...
        formFilter.addEventListener('input', () => {
            ...
            const resalt = currentArrLamps.filter(lamp => {
                ...
                for (let key in objectFilter) {
                    ...
                    if (key === 'wats-segment') {
                        const from = +objectFilter[key][0].split('-')[0];
                        const to = +objectFilter[key][0].split('-')[1];
                        const str = lamp.wats;
                        // wats - значение сколько ват у данного обьекта lamp, получаем с поля lamp.wats
                        const wats = typeof str !== 'undefined' ? parseInt(str) : undefined;
                        ...
                        isMatch = objectFilter[key].includes(lamp[key]);
                    }
                    if (isMatch) {
                        totalMatch++;
                    }
...
const lustre_spot_1 = __webpack_require__(/*! ../../../ajax/lustre-spot */ "./ajax/lustre-spot.ts");
        ...
        if (lampsBlock) {
            ...
            switch (typeLamps) {
                ...
                case 'light':
                    ...
                    break;
                case 'spot':
                    currentArrLamps = lustre_spot_1.spot;
                    break;
                default:
                    currentArrLamps = [];
                    break;
